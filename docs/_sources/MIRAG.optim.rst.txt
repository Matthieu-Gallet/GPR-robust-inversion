...
-------------------------
Module de résolution du problème pour le GPR en utilisant l'`ADMM`,
pour la résolution du problème suivant:

:math:`\left\{\begin{array}{ll}\mathbf{minimiser}\quad 
...
Variante avec optimisation par norme d'Huber à la place de la norme 2
...
:math:`\left\{\begin{array}{ll}\mathbf{minimiser} \quad &||\mathbf{L}||_* +
